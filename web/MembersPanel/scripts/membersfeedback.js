            ...
            if(doc.exists){
                 const userInfo = doc.data()
                    ...
                    <br><br><br>
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.f1}">
                                             </div>
                                             <div class="col-sm-5">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.f2}">
                                             </div>
                                             <div class="col-sm-5">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.f3}">
                                             </div>
                                             <div class="col-sm-5">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.f4}">
                                             </div>
                                             <div class="col-sm-5">
                                             ...
                                             <div class="form-group row">
                                             <label for="f5" class="col-sm-8 col-form-label">What are the necessary changes we need to make if any ? (Give any necessary input)
                                             </label>
                                             <div class="col-sm-6">
                                             <input type="text" readonly  class="form-control" value="${userInfo.f5}">
                                             </div>
                                             <div class="col-sm-6">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.f6}">
                                             </div>
                                             <div class="col-sm-5">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.f7}">
                                             </div>
                                             <div class="col-sm-5">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.f8}">
                                             </div>
                                             <div class="col-sm-5">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.f9}">
                                             </div>
                                             <div class="col-sm-5">
                    ...
                    <br><br>
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.sudhanshu}">
                                             </div>
                                             <div class="col-sm-2">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.arnav}">
                                             </div>
                                             <div class="col-sm-2">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.ankur}">
                                             </div>
                                             <div class="col-sm-2">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.sanjushree}">
                                             </div>
                                             <div class="col-sm-2">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.rudra}">
                                             </div>
                                             <div class="col-sm-2">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.rahul}">
                                             </div>
                                             <div class="col-sm-2">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.jimpi}">
                                             </div>
                                             <div class="col-sm-2">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.krishnakshi}">
                                             </div>
                                             <div class="col-sm-2">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.jai}">
                                             </div>
                                             <div class="col-sm-2">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.vedant}">
                                             </div>
                                             <div class="col-sm-2">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.amit}">
                                             </div>
                                             <div class="col-sm-2">
                                             ...
                                             <div class="col-sm-1">
                                             <input type="text" readonly  class="form-control" value="${userInfo.shruti}">
                                             </div>
                                             <div class="col-sm-2">
                        ...
                        `
                        editProfile["name"].value = userInfo.f1
                        editProfile["email"].value = userInfo.f1
                        editProfile["regno"].value = userInfo.f1
                        editProfile["f1"].value = userInfo.f1
                        editProfile["f2"].value = userInfo.f2
                        editProfile["f3"].value = userInfo.f3
                        editProfile["f4"].value = userInfo.f4
                        editProfile["f5"].value = userInfo.f5
                        editProfile["f6"].value = userInfo.f6
                        editProfile["f7"].value = userInfo.f7
                        editProfile["f8"].value = userInfo.f8
                        editProfile["f9"].value = userInfo.f9
                        editProfile["sudhanshu"].value = userInfo.sudhanshu
                        editProfile["arnav"].value = userInfo.arnav
                        editProfile["ankur"].value = userInfo.ankur
                        editProfile["sanjushree"].value = userInfo.sanjushree
...
function updateUserProfile(e){
    ...
    userDocRef.update({
        f1:editProfile["name"].value,
        f1:editProfile["regno"].value,
        f1:editProfile["email"].value,
        f1:editProfile["f1"].value,
        f2:editProfile["f2"].value,
        f3:editProfile["f3"].value,
        f4:editProfile["f4"].value,
        f5:editProfile["f5"].value,
        f6:editProfile["f6"].value,
        f7:editProfile["f7"].value,
        f8:editProfile["f8"].value,
        f9:editProfile["f9"].value,
        sudhanshu:editProfile["sudhanshu"].value,
        arnav:editProfile["arnav"].value,
        ankur:editProfile["ankur"].value,
        sanjushree:editProfile["sanjushree"].value
